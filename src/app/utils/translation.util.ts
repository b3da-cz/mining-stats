...
export class TranslationUtil {
  ...
  static get translations(): Array<Translation> {
    return [
      ...
      { token: 'backup.local', cs: 'Lokální záloha', en: 'Local backup' },
      { token: 'backup.cloud', cs: 'Záloha na server', en: 'Cloud backup' },
      { token: 'url.backup', cs: 'URL pro zálohy', en: 'Backup URL' },
      { token: 'url.restore', cs: 'URL pro obnovu', en: 'Restore URL' },
      { token: 'cloud.user', cs: 'Uživatel na serveru', en: 'Cloud username' },
      { token: 'cloud.password', cs: 'Heslo na serveru', en: 'Cloud password' },
      { token: 'cipher.passphrase', cs: 'Šifrovací fráze', en: 'Cipher passphrase' },
      { token: 'settings.save', cs: 'Uložit nastavení', en: 'Save settings' },
      { token: 'settings.saved', cs: 'Nastavení uloženo', en: 'Settings saved' },
      { token: 'data.cloud.backup', cs: 'Odeslat data na server', en: 'Backup on cloud' },
